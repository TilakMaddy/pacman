...
var CLASS_LIST = [OBJECT_TYPE.BLANK, OBJECT_TYPE.WALL, OBJECT_TYPE.DOT, OBJECT_TYPE.BLINKY, OBJECT_TYPE.PINKY, OBJECT_TYPE.INKY, OBJECT_TYPE.CLYDE, OBJECT_TYPE.PILL, OBJECT_TYPE.PACMAN, OBJECT_TYPE.GHOSTLAIR];
...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function createGrid(level) {
      ...
      this.DOMGrid.style.cssText = "\n      grid-template-columns: repeat(".concat(_setup.GRID_SIZE, ", ").concat(_setup.CELL_SIZE, "px);\n    ");
      level.forEach(function (squareValue) {
...
var Ghost = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Ghost, [{
    ...
    key: "setNewPos",
    value: function setNewPos(nextPos, dir) {
      this.dir = dir;
      this.pos = nextPos;
    }
  }]);
...
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js"}],"ghostMoves.js":[function(require,module,exports) {
"use strict";
...
var GLOBAL_SPEED = 80; // initial setup

var score = 0;
var timer = null;
var gameWin = false; //keep track whether or not pacman ate the power pill which will be active
...
function gameLoop(pacman, ghosts) {
  ...
  if (pacman.powerPill !== powerPillActive) {
    ...
    ghosts.forEach(function (ghost) {
      return ghost.isScared = powerPillActive;
    });
  }
...
function startGame() {
  ...
  var pacman = new _Pacman.default(287, 2);
